...
const coaches = [
  ...
  { id: 'coach-4', name: '陈静', initial: '陈', level: '雪场高级教练', category: '雪场教练', price: 400, rating: 4.7, reviews: 156, years: 5, resort: '长白山万达', skill: '双板 安全入门 家庭课', teachTags: ['双板', '安全入门', '家庭课'], certificates: ['雪场高级教练认证', '儿童安全教学培训'], intro: '熟悉长白山雪道和家庭客群需求，擅长安排安全、轻松的入门课程。', suitable: '家庭游客、零基础成人、儿童启蒙', plan: '装备适配、基础滑行、安全控速、亲子练习。', avatar: '/images/coach-chenjing.png' },
  { id: 'coach-5', name: '刘洋', initial: '刘', level: 'PSIA Level 2', category: '专业教练', price: 680, rating: 4.9, reviews: 189, years: 9, resort: '崇礼云顶', skill: '刻滑 Carving 进阶纠错', teachTags: ['刻滑', 'Carving', '进阶纠错'], certificates: ['PSIA Alpine Level 2', '视频动作分析认证'], intro: '专注中高级刻滑和动作纠错，会结合视频反馈调整重心、立刃和转弯节奏。', suitable: '中级进阶、刻滑提升、技术纠错', plan: '动作拍摄、问题诊断、立刃训练、连续弯节奏。', avatar: '/images/coach-liuyang.png' },
  { id: 'coach-6', name: '赵然', initial: '赵', level: 'CASI Level 2', category: '专业教练', price: 620, rating: 4.8, reviews: 143, years: 7, resort: '新疆阿勒泰', skill: '单板 粉雪 地形适应', teachTags: ['单板', '粉雪', '地形适应'], certificates: ['CASI Level 2', '野雪安全基础培训'], intro: '擅长单板粉雪和自然地形适应训练，适合想从雪道滑行过渡到更复杂地形的学员。', suitable: '单板进阶、粉雪体验、地形训练', plan: '重心后移控制、粉雪转弯、地形观察、安全线路。', avatar: '/images/coach-zhaoran.png' },
  { id: 'coach-7', name: '孙浩', initial: '孙', level: '驻场教练', category: '雪场教练', price: 360, rating: 4.6, reviews: 98, years: 4, resort: '新疆阿勒泰', skill: '双板 初级路线 雪场陪滑', teachTags: ['双板', '初级路线', '雪场陪滑'], certificates: ['雪场驻场教练认证'], intro: '熟悉阿勒泰初中级路线，适合首次到场用户快速熟悉雪道和安全规则。', suitable: '首次到场、初级路线熟悉、陪滑指导', plan: '雪道讲解、路线选择、基础控速、风险提醒。', avatar: '/images/coach-sunhao.png' },
  { id: 'coach-8', name: '周婧', initial: '周', level: '儿童专项教练', category: '雪场教练', price: 420, rating: 4.8, reviews: 176, years: 6, resort: '长白山万达', skill: '儿童教学 亲子课程 双板', teachTags: ['儿童教学', '亲子课程', '双板'], certificates: ['儿童滑雪教学认证', '雪场安全员培训'], intro: '擅长儿童启蒙和亲子课程设计，课程中会加入游戏化练习，提高孩子的参与度。', suitable: '4-12岁儿童、亲子课程、双板启蒙', plan: '热身游戏、平衡练习、刹车转弯、亲子互动。', avatar: '/images/coach-zhoujing.png' },
  { id: 'coach-9', name: '何然', initial: '何', level: '自由式专项', category: '专业教练', price: 720, rating: 4.9, reviews: 121, years: 8, resort: '崇礼云顶', skill: '自由式 平花 小跳台', teachTags: ['自由式', '平花', '小跳台'], certificates: ['自由式滑雪专项训练认证', '急救培训证书'], intro: '自由式专项教练，适合有稳定滑行基础后学习平花组合、小跳台入门和动作安全落地。', suitable: '自由式入门、平花组合、小跳台基础', plan: '动作分解、低速练习、跳台安全、落地稳定。', avatar: '/images/coach-heran.png' }
]
